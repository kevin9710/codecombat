...
config.salt = process.env.COCO_SALT or 'hello pepper'
config.cookie_secret = process.env.COCO_COOKIE_SECRET or 'hello chips ahoy'
...
config.buildInfo = { sha: '17fa3411a9094d3a11dc3a575970416d015c7bcf' }
